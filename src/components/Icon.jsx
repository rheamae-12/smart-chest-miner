...
const PATHS = {
  ...
  eyeOff: (
    <>
      <path d="M3 3l18 18" />
      <path d="M10.6 6.2A9.4 9.4 0 0 1 12 6c6 0 9.5 6 9.5 6a16 16 0 0 1-3.1 3.7" />
      <path d="M6.2 6.8C3.8 8.2 2.5 12 2.5 12s3.5 6 9.5 6c1.1 0 2.1-.2 3-.5" />
    </>
  ),
  clock: (
    <>
  ...
  brain: (
    <>
      <path d="M9.5 4.2A3.4 3.4 0 0 0 6 7.5c0 .4.1.8.2 1.1A3.8 3.8 0 0 0 4 12.1c0 1.5.8 2.8 2 3.5A3.4 3.4 0 0 0 9.5 19" />
      <path d="M14.5 4.2A3.4 3.4 0 0 1 18 7.5c0 .4-.1.8-.2 1.1a3.8 3.8 0 0 1 2.2 3.5c0 1.5-.8 2.8-2 3.5a3.4 3.4 0 0 1-3.5 3.4" />
      <path d="M9.5 4.2v15.6M14.5 4.2v15.6M9.5 9.5c1.2 0 2.1.8 2.1 2.1s-.9 2.1-2.1 2.1M14.5 9.5c-1.2 0-2.1.8-2.1 2.1s.9 2.1 2.1 2.1" />
    </>
  ),
  grid: (
    <>
