...
export default function StatCard({ label, value, unit, color, sub, tone = "neutral" }) {
  ...
  return (
    <div style={{ ...cardStyle, padding: "15px 16px", minWidth: 0, position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "absolute", top: -38, right: -34, width: 92, height: 92, borderRadius: "50%", background: `${accent}14`, pointerEvents: "none" }} />
      ...
      <div style={{ display: "flex", alignItems: "baseline", gap: 4, minWidth: 0, flexWrap: "wrap" }}>
        <span style={{ fontSize: 28, fontWeight: 900, color: accent, overflow: "hidden", textOverflow: "ellipsis", lineHeight: 1 }}>{value}</span>
